...
createApp({
    setup() {
        ...
        const apps = ref([
            ...
            { id: 8, name: "ChatSafe", developer: "Secure Net", category: "Social", rating: 4.3, size: "30 MB", icon: "https://picsum.photos/seed/chat/200/200", description: "Encrypted messaging app.", link: "#", screenshots: ["https://picsum.photos/seed/chat/200/200", "https://picsum.photos/seed/chat/200/200", "https://picsum.photos/seed/chat/200/200"] }
        ]);
